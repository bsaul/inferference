---
title: "A Cursory Intro to `rinterference` "
author: 
- name : "Bradley Saul"
...
vignette: >
  \VignetteIndexEntry{cursory_rinterference}
  \VignetteEngine{knitr::rmarkdown}
  \usepackage[utf8]{inputenc}
---

# Use of `rinterference` 

This is a VERY brief and unfinished description of how to use the `rinterference` package.
...
The primary function in \pkg{rinterference} is `interference`. Currently, it only supports IPW estimation. `interference` has several options:
...
Take a quick look using the (unpolished) `summary` function:
```{r, echo = TRUE}
summary(sample1)
```
